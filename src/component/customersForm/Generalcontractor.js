...
class Generalcontractor extends Component {
  state= {
    yourName:null,
    yourEmail:null,
    companyName:null,
...
handleChange = (e) => {
  this.setState({
    ...
    render(){
        return(
            <div className="generalcontractor">
                <div className="forms">
                 <div className="container">
            <div className="row">
              <div className="col-sm-6">
                  <h1>General contractor?  <br/>
                  Take back control of your project</h1>
                  <p>
                  Bring order to your construction site,
                   making your projects run smoother and more profitably.  
                  </p>
               <ul>
                   <li>
                   ...
                   <li>
                       <i className="fa fa-check"></i>
                       <p>Complete buildings to a higher build quality. </p>
                   ...
                   <li>
                   <i className="fa fa-check"></i> 
                   <p>Improve relationships with inverstors, subcontractors and suppliers.</p>
                   </li>
                   <li>
                   <i className="fa fa-check"></i> 
               ...
               <p>These general contractors already use ProperGate: </p>
